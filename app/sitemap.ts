...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const STATIC_ROUTES: Array<{
    ...
    { path: "/locations/vancouver-wa", changeFrequency: "monthly", priority: 0.9 },
    { path: "/locations/portland-or", changeFrequency: "monthly", priority: 0.9 },
    { path: "/autism-evaluation-vancouver-wa", changeFrequency: "monthly", priority: 0.9 },
    { path: "/autism-evaluation-portland-or", changeFrequency: "monthly", priority: 0.9 },
