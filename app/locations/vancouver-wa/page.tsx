...
const FAQS: ArticleFaq[] = [
  ...
  },
  {
    ...
    answer:
      "PacificSource, BlueCross BlueShield, Aetna, Cigna, UnitedHealthcare, Kaiser Permanente, and TRICARE, plus Washington DSHS–DDA funding. Apple Health participation is plan-specific and changes over time, so call (360) 622-2253 and we'll tell you where things stand for your plan.",
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            locationSchema({
              path: PATH,
              name: "Strides Therapeutic Services in Vancouver, WA",
              description: DESCRIPTION,
              areaServed: [
                "Vancouver, WA",
                "Camas, WA",
