...
const FAQS: ArticleFaq[] = [
  ...
  },
  {
    ...
    answer:
      "The diagnostic report is written to clinical standards that travel: Oregon insurers require a formal diagnosis before authorizing ABA, schools use it in support conversations, and it can inform Oregon DDS eligibility work. Whether a specific program accepts any outside evaluation is that program's decision — we write reports to hold up to that scrutiny.",
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            locationSchema({
              path: PATH,
              name: "Autism Testing for Portland Families — Strides Therapeutic Services",
              description: DESCRIPTION,
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            breadcrumbSchema([
              ...
              { name: "Autism Testing — Portland, OR", path: PATH },
            ])
          ),
        }}
      />
